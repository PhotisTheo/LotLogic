    ...
    sections = [
        ...
        },
        {
            ...
            "items": [
                ...
                ("Assessed Total Value", _format_currency(parcel.total_value)),
                ("Assessed Land Value", _format_currency(attrs.get("LAND_VAL"))),
                ("Assessed Building Value", _format_currency(attrs.get("BLDG_VAL"))),
